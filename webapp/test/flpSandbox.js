		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#SYNCzdcmmui5gisg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SYNCzdcmmui5gisg-display": {
								"semanticObject": "SYNCzdcmmui5gisg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=SYNC.zdcmmui5gisg",
									"url": sap.ui.require.toUrl("SYNC/zdcmmui5gisg")
								}
							}
						}
					}
